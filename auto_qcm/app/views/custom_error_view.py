...
def custom_permission_denied_view(request, exception=None):
    return custom_error_view(request, exception, template_name='errors/403.html', status=403)

def custom_page_not_found_view(request, exception=None):
    return custom_error_view(request, exception, template_name='errors/404.html', status=404)
