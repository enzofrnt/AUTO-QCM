    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groupe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groupes', to='auth.group')),
                ('promo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='promos', to='auth.group')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('plages', models.ManyToManyField(blank=True, related_name='qcms', to='app.plage')),
